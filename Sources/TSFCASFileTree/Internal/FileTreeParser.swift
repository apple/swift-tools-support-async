...
struct CASFileTreeParser {
    ...
    public func parseCASObject(
        id: LLBDataID, path: AbsolutePath, casObject: LLBCASObject,
        ...
        case nil:
            do {
                ...
                throw LLBCASFileTreeFormatError.formatError(
                    reason:
    ...
    func parseDirectory(id: LLBDataID, path: AbsolutePath, casObject: LLBCASObject) throws -> (
    ...
    internal static func getAnnotation(id: LLBDataID, object: LLBCASObject) throws
