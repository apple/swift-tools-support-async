...
public final class PSProcess: Sendable {
    ...
    public func run() throws {
        ...
        let devNullFD: CInt
        if state.standardInput.isSetToNone || state.standardOutput.isSetToNone
            || state.standardError.isSetToNone
        {
...
func copyOwnedCTypedStringArray(_ array: [String]) -> UnsafeMutablePointer<
    UnsafeMutablePointer<CChar>?
> {
    let out = UnsafeMutableBufferPointer<UnsafeMutablePointer<CChar>?>.allocate(
